...
Production desktop WebKit: 16.23 units of visible movement. Chromium with injected iPhone depth failure: empty-fragment fallback, 26.77 units of visible touch movement and passing capture-loss, cancellation, menu and blur recovery. User confirmed the production game works on their phone after this release. This confirms reported usability; no on-device frame-time measurement was supplied. Production evidence is under `ve-capture/ashen-reach/street-lights/production-2dc981b/`.
