...
async function main(){
 ...
 globalThis.ASHEN={engine,scene,camera,reference,rig,player,body,world,combat,armory,equipment,input,setView,reset,metrics:{summary,reset(){samples.length=0;}},capture:()=>captureScreenshot(engine)};
