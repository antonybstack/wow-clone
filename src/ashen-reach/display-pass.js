...
export function createDisplayPass(engine,scene,source){
 ...
 task.record=()=>{setEffectTexture(effect,'source',{view:source._colorView});state.resolution=[source._width,source._height];return record();};
 task.execute=()=>{
