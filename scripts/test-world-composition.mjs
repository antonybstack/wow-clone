...
test('ash fades before lens and distant silhouettes without a discontinuity',()=>{
 assert.equal(moteVisibility(0),0);assert.equal(moteVisibility(.6),0);
 assert.equal(moteVisibility(3),1);assert.equal(moteVisibility(18),1);
