...
try{
 ...
 await place(0,102);await p.evaluate(()=>ASHEN.localLights.state.details=false);await label('V16 · Diagnostic · Material detail and lantern highlights off');await wait();await p.screenshot({path:`${dir}/off.png`});
