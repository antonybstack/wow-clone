...
const outDir = 've-capture/ashen-reach/world-expansion-m2/views';
...
// Diagnostic camera placements (direct state set, labelled as such) to show each building type,
// the main street, the well square and a wide town view.
const shots = [
...
// Wide town view: pull the camera back and raise the pitch for an overlook.
await page.evaluate(() => {
 const A = window.ASHEN;
 const x=0, z=100;
 const y = A.world.groundHeight(x,z) + 1.7;
