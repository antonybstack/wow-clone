...
// Live-walk proof: hold KeyW from spawn and confirm the player's world z position reaches >=134
// (Hollowmere/road walkability invariant), then screenshot near the well square.
const outDir = 've-capture/ashen-reach/world-expansion-m3b/walk';
