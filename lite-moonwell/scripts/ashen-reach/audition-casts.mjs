...
try{
 await p.bringToFront();await p.goto('http://127.0.0.1:5180/ashen-reach.html?play&clean',{waitUntil:'commit'});await p.waitForFunction(()=>window.ASHEN?.ready,null,{timeout:60000});await p.waitForTimeout(500);
...
}finally{await p.goto('http://127.0.0.1:5180/ashen-reach.html?play&clean',{waitUntil:'commit'});await b.close();}
