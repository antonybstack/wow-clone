...
test('Equipment pack preserves all 54 authored clips exactly',()=>{assert.equal(source.getRoot().listAnimations().length,54);assert.deepEqual(animations(equipped),animations(source));});
