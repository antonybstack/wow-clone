...
Run from `lite-moonwell` with Vite 5180 and owned Chrome CDP 9337. Browser scripts share one target and must run sequentially.
...
Reproduce the magic-set pass from `lite-moonwell` (browser commands run sequentially):
